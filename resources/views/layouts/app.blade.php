...
<head>
    ...
    <title>{{ config('app.name', 'DriverFind') }}</title>
...
<body class="h-screen antialiased leading-none font-sans">
    <div id="app">
        <header class="bg-gradient-to-r from-gray-700 via-gray-900 to-black py-6">
            <div class="container mx-auto flex justify-between items-center px-6">
                ...
                <nav class="space-x-4 text-white text-sm sm:text-base">
                    ...
                    <a class="no-underline hover:underline" href="/candidates">Candidates</a>
                    @guest
